# ============================================================
# FILE: pages/6_📊_Performance_Center.py
# PURPOSE: Consolidated performance tracking hub combining
#          Model Health and Bet Tracker into one unified page.
# TABS:
#   1. 📊 Dashboard   — Overall metrics + win rate by tier/platform/stat
...
st.set_page_config(
    page_title="Performance Center — SmartBetPro NBA",
    page_icon="📊",
    layout="wide",
)
...
with tab_bets:
    ...
    if not all_bets:
        ...
        if pending_bets:
            ...
            with st.form("mark_result_form_pc"):
...
with tab_log:
    ...
    with st.form("log_bet_form_pc", clear_on_submit=True):
