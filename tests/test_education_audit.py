...
_PAGE_FILES = [
    ...
    ("pages/6_🔮_Player_Simulator.py", "📖 How to Use"),
    ("pages/7_🧬_Entry_Builder.py", "📖 How to Use"),
    ("pages/8_🎙️_The_Studio.py", "📖 How to Use"),
    ("pages/9_🛡️_Risk_Shield.py", "📖 How to Use"),
    ("pages/10_📡_Data_Feed.py", "📖 How to Use"),
    ("pages/11_🗺️_Correlation_Matrix.py", "📖 How to Use"),
    ("pages/12_📈_Bet_Tracker.py", "📖 How to Use"),
    ("pages/13_📊_Backtester.py", "📖 How to Use"),
    ("pages/14_⚙️_Settings.py", "📖 How to Use"),
    ("pages/15_💎_Subscription_Level.py", "📖 How"),
]
